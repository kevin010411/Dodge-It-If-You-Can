...
{
	[SerializeField]
	protected DurationBulletType BulletInfo;

	private BulletTypeFactory factory;
	protected SpriteRenderer myRenderer;
	protected Vector2 InitPos;
	protected double StartTime;
	public virtual void Init(Dictionary<string, string> bulletsParams, double startTime,
		Vector2 initPos)
	{
		Sprite sprite = null;
	...
	protected Vector2 NormalizeDirection(string DirStr)
	{
	...
	public virtual void ComputePosition(float timeStamp)
	{
